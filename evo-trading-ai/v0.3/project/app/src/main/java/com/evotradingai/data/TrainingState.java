...
public final class TrainingState {
    ...
    private static JSONArray matrix(double[][] m){JSONArray a=new JSONArray();for(double[] row:m){JSONArray r=new JSONArray();for(double v:row)r.put(v);a.put(r);}return a;}
